<?php
    ...
    echo '<div class="col col-lg-6">
            ...
            $ordem = $_POST['ordemQuantidade'];

            $remedios = $remedioDao->buscarOrdenadoPorQuantidade($ordem);
                ...
                echo '<div class="remedio">
                        ...
                        <div>
                            <div id="botoes">
                                ...
                                <div>
                                    <form action="editar.php?id='.$remedio->getId().'&from=pesquisaordemquantidade" method="post">
